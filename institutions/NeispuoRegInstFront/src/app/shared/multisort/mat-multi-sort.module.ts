...
import { DirectionDisplayPipe } from "../../pipes/direction.pipe";

@NgModule({
  declarations: [MatMultiSortHeaderComponent, MatMultiSort, MatMultiSortTableSettingsComponent, DirectionDisplayPipe],
  exports: [MatMultiSortHeaderComponent, MatMultiSort, MatMultiSortTableSettingsComponent, DirectionDisplayPipe],
  imports: [
    CommonModule,
    MatCommonModule,
    MatDividerModule,
