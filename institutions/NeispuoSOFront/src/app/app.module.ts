...
import { ListViewComponent } from "./pages/sample-list/list-view/list-view.component";
...
import { CustomTableComponent } from './pages/admin/info-table/custom-table/custom-table.component';
...
@NgModule({
  declarations: [
    ...
    ButtonComponent,
    DateTimeComponent,
    NewSubjectInstitutionComponent,
    RegixButtonComponent,
    NewStaffPositionComponent,
    InfoTableWrapperComponent,
