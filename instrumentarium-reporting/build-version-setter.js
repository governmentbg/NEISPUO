...
const packageFiles = [
  './package.json',
  './package-lock.json',
  './reporting-backend/package.json',
  './reporting-backend/package-lock.json',
  './reporting-frontend/package.json',
  './reporting-frontend/package-lock.json',
  './reporting-cubejs/package.json',
  './reporting-cubejs/package-lock.json',
  './reporting-sync/package.json',
  './reporting-sync/package-lock.json',
];
...
execSync(
  `git remote set-url origin https://georgi.kotov:${process.env.AZURE_PAT_DECODED}@dev.azure.com/dssbg/NEISPUO%20Maintenance/_git/mon-neispuo-instrumentarium-reporting`,
);
