...
export class OccupationsByQualificationsDBViewCreation1677450589892
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        VALUES
        ('${SysSchemaEnum.R_OCCUPATIONS_BY_QUALIFICATIONS}', ${SysRoleEnum.MON_ADMIN});`);
    await queryRunner.query(`
        INSERT INTO "reporting"."SchemaRoleAccess"("SchemaName", "AllowedSysRole")
        VALUES
        ('${SysSchemaEnum.R_OCCUPATIONS_BY_QUALIFICATIONS}', ${SysRoleEnum.CIOO});`);

    await queryRunner.query(`
 		CREATE VIEW [reporting].[R_Occupations_By_Qualifications]
		AS
		WITH cte AS
		(
		SELECT
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
       ...
       WHERE SchemaName='${SysSchemaEnum.R_OCCUPATIONS_BY_QUALIFICATIONS}'`);

    await queryRunner.query(`
       DROP VIEW "reporting"."R_Occupations_By_Qualifications"`);
  }
}
