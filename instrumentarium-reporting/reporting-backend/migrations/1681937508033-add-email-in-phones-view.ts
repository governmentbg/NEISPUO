...
export class addEmailInPhonesView1681937508033 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP VIEW [inst_basic].[Phones];`);

    await queryRunner.query(
      `
	CREATE VIEW [inst_basic].[Phones]
AS SELECT DISTINCT A.InstitutionID AS [InstitutionID]
		...
		, inst_basic.InstitutionDetail.Email AS Email
