...
export class createRStudentsDetailsView1682336344305
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        VALUES
        ('${SysSchemaEnum.R_STUDENTS_DETAILS}', ${SysRoleEnum.MON_ADMIN});`);

    await queryRunner.query(`
        INSERT INTO "reporting"."SchemaRoleAccess"("SchemaName", "AllowedSysRole")
        VALUES
        ('${SysSchemaEnum.R_STUDENTS_DETAILS}', ${SysRoleEnum.CIOO});`);

    await queryRunner.query(`
        INSERT INTO "reporting"."SchemaRoleAccess"("SchemaName", "AllowedSysRole")
        VALUES
        ('${SysSchemaEnum.R_STUDENTS_DETAILS}', ${SysRoleEnum.RUO});`);

    await queryRunner.query(`
        INSERT INTO "reporting"."SchemaRoleAccess"("SchemaName", "AllowedSysRole")
        VALUES
        ('${SysSchemaEnum.R_STUDENTS_DETAILS}', ${SysRoleEnum.RUO_EXPERT});`);

    await queryRunner.query(`
        INSERT INTO "reporting"."SchemaRoleAccess"("SchemaName", "AllowedSysRole")
        VALUES
        ('${SysSchemaEnum.R_STUDENTS_DETAILS}', ${SysRoleEnum.INSTITUTION});`);
