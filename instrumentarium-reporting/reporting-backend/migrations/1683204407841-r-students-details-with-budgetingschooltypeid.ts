...
export class UpdateStudentsDetailsWithBudgetingSchoolType1683204407841
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            DROP VIEW [reporting].[R_StudentsDetails];
    `);
    ...
    AS
       SELECT
           ...
           ,ins.BudgetingSchoolTypeID AS BudgetingSchoolTypeID -- Финансираща институция
        ...
        FROM
            ...
            INNER JOIN core.Institution ins on ins.InstitutionId = sc.InstitutionId
    ...
    UNION ALL
        ...
        SELECT DISTINCT
           ...
           ,ins.BudgetingSchoolTypeID AS BudgetingSchoolTypeID
