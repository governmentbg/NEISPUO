...
export class AddRAverageGradesPerStudentView1757074405000
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        VALUES
        ('${SysSchemaEnum.R_AVERAGE_GRADES_PER_STUDENT}', ${SysRoleEnum.MON_ADMIN}),
        ('${SysSchemaEnum.R_AVERAGE_GRADES_PER_STUDENT}', ${SysRoleEnum.MON_EXPERT}),
        ('${SysSchemaEnum.R_AVERAGE_GRADES_PER_STUDENT}', ${SysRoleEnum.RUO_EXPERT}),
        ('${SysSchemaEnum.R_AVERAGE_GRADES_PER_STUDENT}', ${SysRoleEnum.RUO}),
        ('${SysSchemaEnum.R_AVERAGE_GRADES_PER_STUDENT}', ${SysRoleEnum.INSTITUTION});`);

    await queryRunner.query(`
    CREATE VIEW [reporting].[R_Average_Grades_Per_Student]
		AS
    ...
    SELECT
        ...
        ClassBookId,
        ClassOrGroupName,
        AVG(Term1Grade) AS AverageTerm1,
        AVG(Term2Grade) AS AverageTerm2,
        AVG(YearGrade) AS AverageYear
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
       ...
       WHERE SchemaName='${SysSchemaEnum.R_AVERAGE_GRADES_PER_STUDENT}'`);

    await queryRunner.query(`
       DROP VIEW [reporting].[R_Average_Grades_Per_Student]`);
  }
}
