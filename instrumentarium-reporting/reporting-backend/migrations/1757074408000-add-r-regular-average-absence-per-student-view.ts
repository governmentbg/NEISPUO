...
export class AddRRegularAverageAbsencePerStudentView1757074408000
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        VALUES
        ('${SysSchemaEnum.R_REGULAR_AVERAGE_ABSENCE_PER_STUDENT}', ${SysRoleEnum.MON_ADMIN}),
        ('${SysSchemaEnum.R_REGULAR_AVERAGE_ABSENCE_PER_STUDENT}', ${SysRoleEnum.MON_EXPERT}),
        ('${SysSchemaEnum.R_REGULAR_AVERAGE_ABSENCE_PER_STUDENT}', ${SysRoleEnum.RUO_EXPERT}),
        ('${SysSchemaEnum.R_REGULAR_AVERAGE_ABSENCE_PER_STUDENT}', ${SysRoleEnum.RUO}),
        ('${SysSchemaEnum.R_REGULAR_AVERAGE_ABSENCE_PER_STUDENT}', ${SysRoleEnum.INSTITUTION});`);

    await queryRunner.query(`
    CREATE VIEW [reporting].[R_Regular_Average_Absence_Per_Student]
		AS
    WITH AbsencesCTE AS (
        SELECT
            r.[RegionID],
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
       ...
       WHERE SchemaName='${SysSchemaEnum.R_REGULAR_AVERAGE_ABSENCE_PER_STUDENT}'`);

    await queryRunner.query(`
       DROP VIEW [reporting].[R_Regular_Average_Absence_Per_Student]`);
  }
}
