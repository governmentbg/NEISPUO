...
export class AddRPGAverageAbsencePerClassView1757074409000
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        VALUES
        ('${SysSchemaEnum.R_PG_AVERAGE_ABSENCE_PER_CLASS}', ${SysRoleEnum.MON_ADMIN}),
        ('${SysSchemaEnum.R_PG_AVERAGE_ABSENCE_PER_CLASS}', ${SysRoleEnum.MON_EXPERT}),
        ('${SysSchemaEnum.R_PG_AVERAGE_ABSENCE_PER_CLASS}', ${SysRoleEnum.RUO_EXPERT}),
        ('${SysSchemaEnum.R_PG_AVERAGE_ABSENCE_PER_CLASS}', ${SysRoleEnum.RUO}),
        ('${SysSchemaEnum.R_PG_AVERAGE_ABSENCE_PER_CLASS}', ${SysRoleEnum.INSTITUTION});`);

    await queryRunner.query(`
    CREATE VIEW [reporting].[R_PG_Average_Absence_Per_Class]
		AS
    WITH AbsencesCTE AS (
        SELECT
            r.[RegionID],
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
       ...
       WHERE SchemaName='${SysSchemaEnum.R_PG_AVERAGE_ABSENCE_PER_CLASS}'`);

    await queryRunner.query(`
       DROP VIEW [reporting].[R_PG_Average_Absence_Per_Class]`);
  }
}
