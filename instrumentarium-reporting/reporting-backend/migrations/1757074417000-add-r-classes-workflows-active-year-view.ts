...
export class AddRClassesWorkflowsActiveYearView1757074417000
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        VALUES
        ('${SysSchemaEnum.R_CLASSES_WORKFLOWS_ACTIVE_YEAR}', ${SysRoleEnum.MON_ADMIN});`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
       DELETE FROM [reporting].[SchemaRoleAccess]
       WHERE SchemaName='${SysSchemaEnum.R_CLASSES_WORKFLOWS_ACTIVE_YEAR}'`);
  }
}
