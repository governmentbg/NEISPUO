...
cube('ROccupationsByQualifications', {
  sql: 'SELECT * FROM R_Occupations_By_Qualifications ORDER BY Year DESC',
  title: 'OpenData - Професии по СПК',
  description:
    'Служи за извършване на справки свързани с данни по професии по СПК.',
  ...
  dimensions: {
    ...
    col2: {
      ...
      type: 'number',
      title:
        'Физически науки, информатика, техника, здравеопазване, опазване на околната среда и Добив и обогатяване на полезни изкопаеми - I ПКС',
    },
    col3: {
      sql: 'col3',
      type: 'number',
      title:
        'Физически науки, информатика, техника, здравеопазване, опазване на околната среда и Добив и обогатяване на полезни изкопаеми - II ПКС',
    },
    col4: {
      sql: 'col4',
      type: 'number',
      title:
        'Физически науки, информатика, техника, здравеопазване, опазване на околната среда и Добив и обогатяване на полезни изкопаеми - III ПКС',
    },
    col5: {
      sql: 'col5',
      type: 'number',
      title:
        'Физически науки, информатика, техника, здравеопазване, опазване на околната среда и Добив и обогатяване на полезни изкопаеми - IV ПКС',
    },
    col6: {
      sql: 'col6',
      type: 'number',
    ...
    col22: {
      ...
      type: 'number',
      title:
        'Селско стопанство, горско стопанство и рибно стопанство, ветеринарна медицина - I ПКС',
    },
    col23: {
      sql: 'col23',
      type: 'number',
      title:
        'Селско стопанство, горско стопанство и рибно стопанство, ветеринарна медицина - II ПКС',
    },
    col24: {
      sql: 'col24',
      type: 'number',
      title:
        'Селско стопанство, горско стопанство и рибно стопанство, ветеринарна медицина - III ПКС',
    },
    col25: {
      sql: 'col25',
      type: 'number',
      title:
        'Селско стопанство, горско стопанство и рибно стопанство, ветеринарна медицина - IV ПКС',
    },
    col26: {
      sql: 'col26',
      type: 'number',
