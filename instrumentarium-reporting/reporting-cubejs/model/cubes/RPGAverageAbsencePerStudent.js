...
cube('RPGAverageAbsencePerStudent', {
  sql: 'SELECT * FROM R_PG_Average_Absence_Per_Student',
  title: 'Справка за отсъствия по ученик – предучилищни групи (ПГ)',
  description:
    'Средни отсъствия по ученици в предучилищни групи (неизвинени и извинени по вид).',

  // preAggregations: {
  //   orderByRegion: {
  //     type: 'rollup',
  //     dimensions: [
  //       RPGAverageAbsencePerStudent.RegionID,
  //       RPGAverageAbsencePerStudent.SchoolYear,
  //       RPGAverageAbsencePerStudent.InstitutionID,
  //       RPGAverageAbsencePerStudent.PersonID,
  //       RPGAverageAbsencePerStudent.FirstName,
  //       RPGAverageAbsencePerStudent.LastName,
  //     ],
  //     measures: [
  //       RPGAverageAbsencePerStudent.countPersonID,
  //       RPGAverageAbsencePerStudent.sumTotalUnexcusedAbsences,
  //       RPGAverageAbsencePerStudent.sumExcusedByMedicalNoticeAbsence,
  //       RPGAverageAbsencePerStudent.sumExcusedByHealthReasonAbsence,
  //       RPGAverageAbsencePerStudent.sumExcusedByFamilyReasonAbsence,
  //       RPGAverageAbsencePerStudent.sumExcusedByOtherReasonAbsence,
  //       RPGAverageAbsencePerStudent.sumTotalExcusedAbsences,
  //     ],
  //     indexes: {
  //       r_pg_average_absence_per_student_index: {
  //         columns: [
  //           RPGAverageAbsencePerStudent.RegionID,
  //           RPGAverageAbsencePerStudent.SchoolYear,
  //           RPGAverageAbsencePerStudent.InstitutionID,
