...
cube('RInstitutions', {
  sql: 'SELECT * FROM reporting.R_Institutions_Table',
  title: 'Институции',
  description: 'Служи за извършване на справки свързани с данни на ниво Институция',
  ...
  measures: {
    countInstitutionID: {
      ...
      drillMembers: [InstitutionID, InstitutionName, ShortInstitutionName, Bulstat, CountryName, RegionName, MunicipalityName, TownName, LocalAreaName, BaseSchoolTypeName, DetailedSchoolTypeName, FinancialSchoolTypeName, BudgetingInstitutionName, IsDelegateBudget, Address, PhoneNumber, Email, Website, EstablishedYear, ConstitActFirst, ConstitActLast, SchoolShiftType, IsCentral, IsProtected, IsInnovative, IsNational, IsProfSchool, IsNonIndDormitory, HasMunDecisionFor4, IsAppInnovSystem, IsODZ, IsProvideEduServ, Director, InstitutionPublicCouncil, StaffCountAll, PedagogStaffCount, NonpedagogStaffCount, TownID, MunicipalityID, RegionID, LocalAreaID, BudgetingSchoolTypeID, YearlyBudget],
    },
  },
