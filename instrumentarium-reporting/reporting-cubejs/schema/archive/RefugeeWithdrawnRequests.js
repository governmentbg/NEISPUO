...
cube('RefugeeWithdrawnRequests', {
  sql: 'SELECT * FROM refugee.RefugeeWithdrawnRequests',
  title: 'Оттеглени заявления от търсещи или получили закрила',
  description: 'Служи за извършване на справки свързани с оттеглени заявления от търсещи или получили закрила.',
