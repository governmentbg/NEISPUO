...
cube('RefugeesSearchingOrReceivedAdmission', {
  sql: 'SELECT * FROM refugee.RefugeesSearchingOrReceivedAdmission',
  title: 'Записани в институция търсещи или получили закрила',
  description: 'Служи за извършване на справки свързани с данни на записани в институция търсещи или получили закрила.',
