...
FROM
	...
	JOIN core.Person p ON p.PersonID = sc.PersonID -- Мaрги - не е необходимо, имаме си го в StudentClass
	...
	LEFT JOIN inst_nom.SPPOOSpeciality spec ON spec.SPPOOSpecialityID = sc.StudentSpecialityId --добавено от Марги
...
--- Currently not possible as view has left join that cannot be removed
CREATE UNIQUE CLUSTERED INDEX IDX_ClassID_InstitutionID_RomeClassName_ClassType_SpecialtyName_EduFormName_PositionId_IsHourlyOrganization_IsNotPresentForm ON reporting.R_students (
	ClassID,
	InstitutionID,
	RomeClassName,
	ClassType,
