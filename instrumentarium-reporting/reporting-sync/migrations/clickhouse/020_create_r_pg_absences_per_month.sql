-- Migration: Create R_PG_Absences_Per_Month table
-- Based on reporting.R_PG_Absences_Per_Month view from the MS SQL server
CREATE TABLE IF NOT EXISTS R_PG_Absences_Per_Month (
    RegionID Int32,
    RegionName String,
