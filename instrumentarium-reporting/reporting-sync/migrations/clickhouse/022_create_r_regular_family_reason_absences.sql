-- Migration: Create R_Regular_Family_Reason_Absences table
-- Based on reporting.R_Regular_Family_Reason_Absences view from the MS SQL server
CREATE TABLE IF NOT EXISTS R_Regular_Family_Reason_Absences (
    RegionID Int32,
    RegionName String,
    ...
    AbsencesTerm1 Nullable(Int32),
    AbsencesTerm2 Nullable(Int32),
