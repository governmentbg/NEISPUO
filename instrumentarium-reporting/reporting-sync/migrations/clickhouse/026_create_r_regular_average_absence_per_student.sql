-- Migration: Create R_Regular_Average_Absence_Per_Student table
-- Based on reporting.R_Regular_Average_Absence_Per_Student view from the MS SQL server
CREATE TABLE IF NOT EXISTS R_Regular_Average_Absence_Per_Student (
    RegionID Int32,
    RegionName String,
