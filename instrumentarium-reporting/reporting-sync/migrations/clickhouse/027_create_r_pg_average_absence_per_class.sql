-- Migration: Create R_PG_Average_Absence_Per_Class table
-- Based on reporting.R_PG_Average_Absence_Per_Class view from the MS SQL server
CREATE TABLE IF NOT EXISTS R_PG_Average_Absence_Per_Class (
    RegionID Int32,
    RegionName String,
