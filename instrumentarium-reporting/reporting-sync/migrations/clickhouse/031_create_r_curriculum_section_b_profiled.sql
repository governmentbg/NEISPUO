-- Migration: Create R_Curriculum_Section_B_Profiled table
-- Based on reporting.R_Curriculum_Section_B_Profiled view from the MS SQL server
CREATE TABLE IF NOT EXISTS R_Curriculum_Section_B_Profiled (
    ...
    `зад. модули към ПП` Nullable(String),
