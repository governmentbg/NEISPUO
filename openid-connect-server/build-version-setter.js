...
const packageFiles = [
  './package.json',
  './package-lock.json',
  './openid/openid-server/package.json',
  './openid/openid-server/package-lock.json',
];
...
execSync(
  `git remote set-url origin https://georgi.kotov:${process.env.AZURE_PAT_DECODED}@dev.azure.com/dssbg/NEISPUO%20Maintenance/_git/mon-neispuo-openid-connect`,
);
