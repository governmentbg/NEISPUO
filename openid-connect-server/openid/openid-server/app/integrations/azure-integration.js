...
module.exports = Issuer.discover(process.env.CLIENT_DISCOVERY)
  .then((azureIssuer) => {
    // console.log('Discovered issuer %s %O', azureIssuer.issuer, azureIssuer.metadata);
    console.log('Azure integration started');
  ...
  .catch((e) => {
    console.log(e);
    console.error('An error occurred in azure-integration.js');
    return null;
  }); // => Client);
