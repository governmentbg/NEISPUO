...
export class UpdateRIInstitutionLatestActive1687330050312 implements MigrationInterface {
    name = 'UpdateRIInstitutionLatestActive1687330050312';
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        WHERE
            ...
            OR _TransformTypeID NOT IN (1, 11, 12, 13, 14, 9)
    `
        );
    }
}
