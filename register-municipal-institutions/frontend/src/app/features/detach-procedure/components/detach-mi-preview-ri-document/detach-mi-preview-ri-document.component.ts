...
@Component({
  selector: 'app-detach-mi-preview-ri-document',
  templateUrl: './detach-mi-preview-ri-document.component.html',
  styleUrls: ['./detach-mi-preview-ri-document.component.scss'],
})
export class DetachMiPreviewRiDocumentComponent implements OnInit, AfterViewInit {
