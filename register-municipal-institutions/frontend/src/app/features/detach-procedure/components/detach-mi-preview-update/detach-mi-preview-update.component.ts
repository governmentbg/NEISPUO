...
@Component({
  selector: 'app-detach-mi-preview-update',
  templateUrl: './detach-mi-preview-update.component.html',
  styleUrls: ['./detach-mi-preview-update.component.scss'],
})
export class DetachMiPreviewUpdateComponent extends MiFormUtility implements OnInit, AfterViewInit, IStatePage, OnChanges, OnDestroy {
  /**
   * Set default mode
   */
  ...
  setFormConfig() {
    this.config = this.miAclService.getConfiguration('TRANSFORM');
  }
}
