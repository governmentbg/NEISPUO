...
@Component({
  selector: 'app-divide-mi-preview-ri-document',
  templateUrl: './divide-mi-preview-ri-document.component.html',
  styleUrls: ['./divide-mi-preview-ri-document.component.scss'],
})
export class DivideMiPreviewRiDocumentComponent implements OnInit, AfterViewInit {
