...
@Component({
  selector: 'app-join-mi-preview-ri-document',
  templateUrl: './join-mi-preview-ri-document.component.html',
  styleUrls: ['./join-mi-preview-ri-document.component.scss'],
})
export class JoinMiPreviewRiDocumentComponent implements OnInit, AfterViewInit {
