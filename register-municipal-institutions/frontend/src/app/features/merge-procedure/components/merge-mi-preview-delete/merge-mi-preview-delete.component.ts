...
@Component({
  selector: 'app-merge-mi-preview-delete',
  templateUrl: './merge-mi-preview-delete.component.html',
  styleUrls: ['./merge-mi-preview-delete.component.scss'],
})
export class MergeMiPreviewDeleteComponent extends MiFormUtility implements OnInit, AfterViewInit, IStatePage, OnDestroy {
  /**
   * Set default mode
   */
