...
public class StateExamsAdmProtocolsWordController : ProtocolsWordController
{
    [ProducesResponseType(typeof(FileResult), 200)]
    [Produces(contentType: OpenXmlExtensions.WordMimeType)]
    [HttpGet]
    public async Task<FileStreamResult> DownloadStateExamsAdmProtocolsWordFileAsync(
        ...
        CancellationToken ct)
    {
        ...
        var protocol = await stateExamsAdmProtocolQueryRepository.GetWordDataAsync(schoolYear, protocolId, ct);
        ...
        var templateName = "StateExamsAdmProtocol";
        ...
        return new FileStreamResult(wordStream, OpenXmlExtensions.WordMimeType) { FileDownloadName = $"3-79_{ protNumAndDate }.docx" };
    }

    [ProducesResponseType(typeof(FileResult), 200)]
    [Produces(contentType: OpenXmlExtensions.WordMimeType)]
    [HttpGet]
    public async Task<FileStreamResult> DownloadStateExamsAdmProtocolsWordTemplateFileAsync(
        [FromRoute] int schoolYear,
        ...
        CancellationToken ct)
    {
        ...
        return new FileStreamResult(wordStream, OpenXmlExtensions.WordMimeType) { FileDownloadName = $"3-79_образец.docx" };
    }
}
