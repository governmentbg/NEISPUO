...
public class RegBookCertificateDuplicatesController : RegBooksController
{
    [HttpGet]
    public async Task<ActionResult<TableResultVO<GetAllVO>>> GetAllAsync(
        ...
        => await regBookCertificateDuplicateQueryRepository.GetAllAsync(
            schoolYear,
            instId,
    ...
    public async Task<ActionResult<GetVO>> GetAsync(
        ...
        [FromServices] IRegBookCertificateDuplicateQueryRepository regBookCertificateDuplicateQueryRepository,
        CancellationToken ct)
        => await regBookCertificateDuplicateQueryRepository.GetAsync(schoolYear, id, ct);
}
