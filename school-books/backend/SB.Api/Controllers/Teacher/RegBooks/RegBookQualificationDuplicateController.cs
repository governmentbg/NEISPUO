...
public class RegBookQualificationDuplicatesController : RegBooksController
{
    [HttpGet]
    public async Task<ActionResult<TableResultVO<GetAllVO>>> GetAllAsync(
        ...
        => await regBookQualificationDuplicateQueryRepository.GetAllAsync(
            schoolYear,
            instId,
    ...
    public async Task<ActionResult<GetVO>> GetAsync(
        ...
        [FromServices]IRegBookQualificationDuplicateQueryRepository regBookQualificationDuplicateQueryRepository,
        CancellationToken ct)
        => await regBookQualificationDuplicateQueryRepository.GetAsync(schoolYear, id, ct);
}
