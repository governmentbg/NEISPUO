...
AS
    SELECT
        ...
        ,InstitutionId
        ,SchoolYear
        ,RegistrationNumberTotal -- [Пореден рег. №]
        ,RegistrationNumberYear  -- [Рег. № за годината]
        ,RegistrationDate        -- [Дата на издаване]
        ,PersonId                -- [Собствено, бащино и фамилно име | ЕГН/ЛНЧ]
        ,BasicDocumentId         -- [Вид документ]
        ,EduFormId               -- [Форма на обучение]
        ,Series                  -- [Серия]
        ,FactoryNumber           -- [Фабричен номер]
        ,IsCancelled             -- [Анулиран]
...
AS
    SELECT
        ...
        ,SchoolYear
        ,BasicDocumentId
        ,RegistrationNumberTotal                                    -- [Рег. № по реда за издаване на документа]
        ,RegistrationNumberYear                                     -- [Рег. № по ред на годината]
        ,RegistrationDate                                           -- [Дата]
        ,PersonId                                                   -- [Собствено, бащино и фамилно име на ученика | ЕГН/ЛНЧ]
        ,EduFormId                                                  -- [Форма на обучение]
        ...
        ,ClassTypeId                                                -- [Общообразователна подготовка / профил]
        ,SPPOOProfessionId                                          -- [Професия]
        ,SPPOOSpecialityId                                          -- [Специалност]
        ,CONCAT_WS(' ', GPAText, IIF(GPA > 0, GPA, NULL)) AS GPA    -- [Общ успех]
        ,Series                                                     -- [Серия на документа]
        ,FactoryNumber                                              -- [№ на документа]
        ,IsCancelled                                                -- [Анулиран]
    FROM document.Diploma
    WHERE BasicDocumentId IN (
