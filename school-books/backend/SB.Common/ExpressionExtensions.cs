...
public static class ExpressionExtensions
{
    ...
    public static Expression<Func<T, bool>> AndAnyStringContains<T>(this Expression<Func<T, bool>> expr, Expression<Func<T, string?>> prop1, Expression<Func<T, string?>> prop2, Expression<Func<T, string?>> prop3, Expression<Func<T, string?>> prop4, string? value)
    {
        if (value == null)
        {
            return expr;
    ...
    public static Expression<Func<T, bool>> AndAnyStringContains<T>(this Expression<Func<T, bool>> expr, Expression<Func<T, string?>> prop1, Expression<Func<T, string?>> prop2, Expression<Func<T, string?>> prop3, Expression<Func<T, string?>> prop4, Expression<Func<T, string?>> prop5, string? value)
    {
        if (value == null)
        {
            return expr;
    ...
    public static Expression<Func<T, bool>> AndDateGreaterThanOrEqual<T>(this Expression<Func<T, bool>> expr, Expression<Func<T, DateTime?>> prop, DateTime? value)
    {
        if (!value.HasValue)
        {
            return expr;
    ...
    public static Expression<Func<T, bool>> AndDateLessThanOrEqual<T>(this Expression<Func<T, bool>> expr, Expression<Func<T, DateTime?>> prop, DateTime? value)
    {
        if (!value.HasValue)
        {
            return expr;
        ...
        return expr.AndPropertyLessThanOrEqual(prop, value.Value.AddDays(1).AddMilliseconds(-1));
    }
