...
internal sealed class Transaction : ITransaction
{
    ...
    public Transaction(IDbContextTransaction transaction, bool childTransaction)
    {
        this.transaction = transaction ?? throw new ArgumentNullException(nameof(transaction));
        this.childTransaction = childTransaction;
    }

    public IDbContextTransaction DbContextTransaction => this.transaction ?? throw new InvalidOperationException("Transaction has already been disposed.");
