...
class RegularGradePointAverageByClassesReportsQueryRepository : Repository, IRegularGradePointAverageByClassesReportsQueryRepository
{
    public RegularGradePointAverageByClassesReportsQueryRepository(UnitOfWork unitOfWork)
        : base(unitOfWork)
    {
    }
    ...
    {
        return await (
            from r in this.DbContext.Set<RegularGradePointAverageByClassesReport>()
            ...
            select new GetAllVO(
                r.SchoolYear,
                r.RegularGradePointAverageByClassesReportId,
        ...
        CancellationToken ct)
    {
        return await (
            ...
            where r.SchoolYear == schoolYear && r.InstId == instId && r.RegularGradePointAverageByClassesReportId == regularGradePointAverageByClassesReportId
    ...
    {
        return await (
            from ri in this.DbContext.Set<RegularGradePointAverageByClassesReportItem>()

            where ri.SchoolYear == schoolYear &&
                  ri.RegularGradePointAverageByClassesReportId == regularGradePointAverageByClassesReportId

            orderby ri.RegularGradePointAverageByClassesReportItemId
        ...
        CancellationToken ct)
    {
        ...
        var curriculums = await (
            from cc in (
                ...
                where level1ClassIds.Contains(cc.ClassId)
            ...
            .Union(
                ...
                where cg.SchoolYear == schoolYear && level2ClassIds.Contains(cg.ClassId)
...
""";
        ...
        var grades = await this.DbContext.Set<RegularGradesByClassesQO>()
            .FromSqlRaw(sql,
                        ...
                        return Enumerable.Concat(
                                ...
                                .Select(ccb =>
                                {
                                    ...
                                    var gradesForCurriculum =
                                        gradesForClassBook.Where(g => g.CurriculumId == ccb.CurriculumId).ToArray();
    ...
    {
        return await (
            from abc in this.DbContext.Set<RegularGradePointAverageByClassesReport>()
            where abc.SchoolYear == schoolYear &&
                abc.RegularGradePointAverageByClassesReportId == regularGradePointAverageByClassesReportId
        ...
        CancellationToken ct)
    {
        ...
        return await (
            ...
            where r.SchoolYear == schoolYear &&
                  r.InstId == instId &&
                  r.RegularGradePointAverageByClassesReportId == regularGradePointAverageByClassesReportId
