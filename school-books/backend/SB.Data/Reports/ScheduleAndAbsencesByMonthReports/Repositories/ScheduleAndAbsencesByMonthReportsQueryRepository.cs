...
internal class ScheduleAndAbsencesByMonthReportsQueryRepository : Repository, IScheduleAndAbsencesByMonthReportsQueryRepository
{
    private readonly int SqlCommandTimeout = 180;

    public ScheduleAndAbsencesByMonthReportsQueryRepository(UnitOfWork unitOfWork)
        : base(unitOfWork)
    {
    }
    ...
    {
        return await (
            from r in this.DbContext.Set<ScheduleAndAbsencesByMonthReport>()
            ...
            select new GetAllVO(
                r.ScheduleAndAbsencesByMonthReportId,
                r.SchoolYear,
                new DateTime(r.Year, r.Month, 1).ToString("yyyy-MM"),
                r.ClassBookName,
                r.CreateDate)
        ...
        CancellationToken ct)
    {
        return await (
            ...
            where r.SchoolYear == schoolYear && r.InstId == instId && r.ScheduleAndAbsencesByMonthReportId == scheduleAndAbsencesByMonthReportId
    ...
    {
        return await (
            from rw in this.DbContext.Set<ScheduleAndAbsencesByMonthReportWeek>()
            join r in this.DbContext.Set<ScheduleAndAbsencesByMonthReport>() on new { rw.SchoolYear, rw.ScheduleAndAbsencesByMonthReportId } equals new { r.SchoolYear, r.ScheduleAndAbsencesByMonthReportId }
            where rw.SchoolYear == schoolYear && r.InstId == instId && rw.ScheduleAndAbsencesByMonthReportId == scheduleAndAbsencesByMonthReportId
            orderby rw.ScheduleAndAbsencesByMonthReportWeekId
    ...
    {
        return await (
            from mtr in this.DbContext.Set<ScheduleAndAbsencesByMonthReport>()
            where mtr.SchoolYear == schoolYear &&
                mtr.ScheduleAndAbsencesByMonthReportId == scheduleAndAbsencesByMonthReportId
        ...
        CancellationToken ct)
    {
        ...
        return await (
            ...
            where r.SchoolYear == schoolYear &&
                  r.InstId == instId &&
                  r.ScheduleAndAbsencesByMonthReportId == scheduleAndAbsencesByMonthReportId
