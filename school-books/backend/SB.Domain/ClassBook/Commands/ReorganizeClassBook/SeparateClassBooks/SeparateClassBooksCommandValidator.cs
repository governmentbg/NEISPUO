...
public class SeparateClassBooksCommandValidator : AbstractValidator<SeparateClassBooksCommand>
{
    public SeparateClassBooksCommandValidator(IValidator<SeparateClassBooksCommandClassBook?> classBookValidator)
    {
