...
public class CreateExamResultProtocolCommandValidator : AbstractValidator<CreateExamResultProtocolCommand>
{
    public CreateExamResultProtocolCommandValidator()
    {
