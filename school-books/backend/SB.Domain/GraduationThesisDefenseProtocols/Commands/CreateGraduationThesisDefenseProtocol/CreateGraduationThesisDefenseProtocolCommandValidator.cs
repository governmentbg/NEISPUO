...
public class CreateGraduationThesisDefenseProtocolCommandValidator : AbstractValidator<CreateGraduationThesisDefenseProtocolCommand>
{
    public CreateGraduationThesisDefenseProtocolCommandValidator()
    {
