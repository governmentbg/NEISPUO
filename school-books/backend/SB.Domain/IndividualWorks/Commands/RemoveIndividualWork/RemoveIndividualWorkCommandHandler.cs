...
internal record RemoveIndividualWorkCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<IndividualWork> IndividualWorkAggregateRepository,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<RemoveIndividualWorkCommand>
{
    public async Task Handle(RemoveIndividualWorkCommand command, CancellationToken ct)
    {
        ...
        this.IndividualWorkAggregateRepository.Remove(individualWork);
