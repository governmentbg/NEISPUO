...
public class CreateNvoExamDutyProtocolCommandValidator : AbstractValidator<CreateNvoExamDutyProtocolCommand>
{
    public CreateNvoExamDutyProtocolCommandValidator()
    {
