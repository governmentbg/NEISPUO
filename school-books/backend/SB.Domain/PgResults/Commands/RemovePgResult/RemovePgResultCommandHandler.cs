...
internal record RemovePgResultCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<PgResult> PgResultAggregateRepository,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<RemovePgResultCommand>
{
    public async Task Handle(RemovePgResultCommand command, CancellationToken ct)
    {
        ...
        this.PgResultAggregateRepository.Remove(pgResult);
