...
public class CreateQualificationAcquisitionProtocolCommandValidator : AbstractValidator<CreateQualificationAcquisitionProtocolCommand>
{
    public CreateQualificationAcquisitionProtocolCommandValidator()
    {
