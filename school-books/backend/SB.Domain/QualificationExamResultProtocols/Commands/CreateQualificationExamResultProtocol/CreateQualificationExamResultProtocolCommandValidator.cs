...
public class CreateQualificationExamResultProtocolCommandValidator : AbstractValidator<CreateQualificationExamResultProtocolCommand>
{
    public CreateQualificationExamResultProtocolCommandValidator()
    {
