...
public class RegBookQualificationDuplicate
{
    // EF constructor
    private RegBookQualificationDuplicate()
    {
    ...
    public string? OrigSeries { get; private set; }

    public string? OrigFactoryNumber { get; private set; }
