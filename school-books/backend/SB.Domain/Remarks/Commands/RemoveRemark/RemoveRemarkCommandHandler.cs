...
internal record RemoveRemarkCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<Remark> RemarkAggregateRepository,
    IQueueMessagesService QueueMessagesService,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<RemoveRemarkCommand>
{
    public async Task Handle(RemoveRemarkCommand command, CancellationToken ct)
    {
