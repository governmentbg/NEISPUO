...
internal record UpdateRemarkCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<Remark> RemarkAggregateRepository,
    IRemarksQueryRepository RemarksQueryRepository,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<UpdateRemarkCommand>
{
    public async Task Handle(UpdateRemarkCommand command, CancellationToken ct)
    {
