...
internal record UpdateReplrParticipationCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<ReplrParticipation> ReplrParticipationAggregateRepository,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<UpdateReplrParticipationCommand>
{
    public async Task Handle(UpdateReplrParticipationCommand command, CancellationToken ct)
    {
