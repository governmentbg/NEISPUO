...
public class RegularGradePointAverageByClassesReport : IAggregateRoot
{
    // EF constructor
    private RegularGradePointAverageByClassesReport()
    {
        this.Version = null!;
    }

    public RegularGradePointAverageByClassesReport(
        int schoolYear,
        int instId,
        ReportPeriod period,
        ...
        int createdBySysUserId)
    {
        ...
        this.items.AddRange(items.Select(i => new RegularGradePointAverageByClassesReportItem(
            i.ClassBookName,
            i.CurriculumInfo,
            i.StudentsCount,
    ...
    public int RegularGradePointAverageByClassesReportId { get; private set; }
    ...
    // relations
    private readonly List<RegularGradePointAverageByClassesReportItem> items = new();
    public IReadOnlyCollection<RegularGradePointAverageByClassesReportItem> Items => this.items.AsReadOnly();
}
