...
public class RegularGradePointAverageByClassesReportItem
{
    // EF constructor
    private RegularGradePointAverageByClassesReportItem()
    {
        this.ClassBookName = null!;
        this.CurriculumInfo = null!;
    }

    public RegularGradePointAverageByClassesReportItem(
    ...
    public int RegularGradePointAverageByClassesReportItemId { get; private set; }
