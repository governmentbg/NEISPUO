...
public class RegularGradePointAverageByClassesReportsExcelExportService : IRegularGradePointAverageByClassesReportsExcelExportService
{
    private readonly IRegularGradePointAverageByClassesReportsQueryRepository regularGradePointAverageByClassesReportsQueryRepository;

    public RegularGradePointAverageByClassesReportsExcelExportService(
        IRegularGradePointAverageByClassesReportsQueryRepository regularGradePointAverageByClassesReportsQueryRepository)
    {
        this.regularGradePointAverageByClassesReportsQueryRepository = regularGradePointAverageByClassesReportsQueryRepository;
    }
    ...
    {
        var report =
            await this.regularGradePointAverageByClassesReportsQueryRepository.GetExcelDataAsync(
                schoolYear,
                instId,
                regularGradePointAverageByClassesReportId,
                ct);
        ...
        {
            titleRowText = $"Среден успех от текущи оценки по класове от {report.ClassBookNames} за {report.Period.ToLower()} към дата {report.CreateDate: dd.MM.yyyy HH:mm}";
        }
        else
        {
            titleRowText = $"Среден успех от текущи оценки по класове за {report.Period.ToLower()} към дата {report.CreateDate: dd.MM.yyyy HH:mm}";
        }
