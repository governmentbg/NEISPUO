...
public class ScheduleAndAbsencesByMonthReportWeekDayHour
{
    // EF constructor
    private ScheduleAndAbsencesByMonthReportWeekDayHour()
    {
    }

    internal ScheduleAndAbsencesByMonthReportWeekDayHour(
        DateTime date,
        int hourNumber,
        bool? isEmptyHour,
