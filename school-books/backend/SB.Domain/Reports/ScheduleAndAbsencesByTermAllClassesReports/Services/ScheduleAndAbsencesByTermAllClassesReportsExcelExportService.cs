...
public class ScheduleAndAbsencesByTermAllClassesReportsExcelExportService : IScheduleAndAbsencesByTermAllClassesReportsExcelExportService
{
    public ScheduleAndAbsencesByTermAllClassesReportsExcelExportService()
    {
    }
        ...
        Stream outputStream)
    {
        ...
        var worksheetPart = workbookPart.AddNewPart<WorksheetPart>("scheduleAndAbsencesByTermAllClassesReport");

        this.FillWorksheetPartAsync(
            term,
            classBookName,
            isDPLR,
            weeks,
        ...
        sheets.AppendChild(
            new Sheet()
            {
                ...
                Name = "отсъствия и теми за срок"
            });
    }

    public void FillWorksheetPartAsync(
        string term,
        string classBookName,
        bool isDPLR,
        GetWeeksForAddVO[] weeks,
        ...
        WorkbookStylesPart workbookStylesPart)
    {
        ...
        worksheetPart.Worksheet.GetColumns()
            ...
            .AppendCustomWidthColumn(5, 5, !isDPLR ? primaryColWidth * 2 : primaryColWidth * 5)
            .AppendCustomWidthColumn(6, 6, !isDPLR ? primaryColWidth * 5 : primaryColWidth * 2);

        var titleRow =
            worksheetPart.Worksheet
                .AppendRelativeRow();

        int totalColumnsCount = !isDPLR ? 6 : 5;

        titleRow
            .AppendRelativeInlineStringCell(
                text: $"Отсъствия/теми за {classBookName} за {term.ToLower()}",
        ...
        string[] headerRow2ColumnTitles = !isDPLR ? new string[] { "уваж.", "неуваж.", "закъснели"} : new string[] { "остъствия", "присъствия" };
        ...
        foreach (var week in weeks)
        {
            ...
            headerRow1
                .AppendRelativeInlineStringCell(
                    text: $"{(isDPLR ? "Отсъстващи ученици" : "Отсъстващи/присъстващи ученици")}",
                    styleIndex: primaryTableCellCenteredBold);
