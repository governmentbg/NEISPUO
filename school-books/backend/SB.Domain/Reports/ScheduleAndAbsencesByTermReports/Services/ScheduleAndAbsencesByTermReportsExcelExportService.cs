...
public class ScheduleAndAbsencesByTermReportsExcelExportService : IScheduleAndAbsencesByTermReportsExcelExportService
{
    private readonly IScheduleAndAbsencesByTermReportsQueryRepository scheduleAndAbsencesByTermReportsQueryRepository;

    public ScheduleAndAbsencesByTermReportsExcelExportService(
        IScheduleAndAbsencesByTermReportsQueryRepository scheduleAndAbsencesByTermReportsQueryRepository)
    {
        this.scheduleAndAbsencesByTermReportsQueryRepository = scheduleAndAbsencesByTermReportsQueryRepository;
    }
        ...
        CancellationToken ct)
    {
        ...
        var worksheetPart = workbookPart.AddNewPart<WorksheetPart>("scheduleAndAbsencesByTermReport");
    ...
    {
        var report =
            await this.scheduleAndAbsencesByTermReportsQueryRepository.GetExcelDataAsync(
                schoolYear,
                instId,
                scheduleAndAbsencesByTermReportId,
                ct);
        ...
        titleRow
            .AppendRelativeInlineStringCell(
                text: $"Отсъствия/теми за {report.ClassBookName} за {report.Term.ToLower()} към дата {report.CreateDate: dd.MM.yyyy HH:mm}",
