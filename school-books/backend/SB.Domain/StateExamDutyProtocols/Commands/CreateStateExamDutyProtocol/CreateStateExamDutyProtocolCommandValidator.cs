...
public class CreateStateExamDutyProtocolCommandValidator : AbstractValidator<CreateStateExamDutyProtocolCommand>
{
    public CreateStateExamDutyProtocolCommandValidator()
    {
