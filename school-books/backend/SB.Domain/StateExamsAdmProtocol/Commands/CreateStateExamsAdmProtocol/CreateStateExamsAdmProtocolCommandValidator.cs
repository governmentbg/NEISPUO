...
public class CreateStateExamsAdmProtocolCommandValidator : AbstractValidator<CreateStateExamsAdmProtocolCommand>
{
    public CreateStateExamsAdmProtocolCommandValidator()
    {
