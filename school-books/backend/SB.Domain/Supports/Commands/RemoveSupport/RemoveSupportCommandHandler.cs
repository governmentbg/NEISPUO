...
internal record RemoveSupportCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<Support> SupportAggregateRepository,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<RemoveSupportCommand>
{
    public async Task Handle(RemoveSupportCommand command, CancellationToken ct)
    {
        ...
        this.SupportAggregateRepository.Remove(support);
