...
internal record RemoveSupportActivityCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<Support> SupportAggregateRepository,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<RemoveSupportActivityCommand>
{
    public async Task Handle(RemoveSupportActivityCommand command, CancellationToken ct)
    {
        ...
        support.RemoveActivity(command.SupportActivityId!.Value, command.SysUserId!.Value);
