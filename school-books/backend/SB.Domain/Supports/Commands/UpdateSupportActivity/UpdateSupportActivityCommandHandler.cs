...
internal record UpdateSupportActivityCommandHandler(
    IUnitOfWork UnitOfWork,
    IScopedAggregateRepository<Support> SupportAggregateRepository,
    IClassBookCachedQueryStore ClassBookCachedQueryStore)
    : IRequestHandler<UpdateSupportActivityCommand>
{
    public async Task Handle(UpdateSupportActivityCommand command, CancellationToken ct)
    {
        ...
        support.UpdateActivity(
            command.SupportActivityId!.Value,
