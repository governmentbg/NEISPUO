...
import {
  ...
  StudentClassBook_GetAbsencesDplr,
  StudentClassBook_GetAbsencesForCurriculumAndType
...
export class AbsencesDplrSkeletonComponent extends SkeletonComponentBase {
  constructor(studentClassBookService: StudentClassBookService, route: ActivatedRoute) {
    ...
    this.resolve(AbsencesDplrComponent, {
      ...
      personId,
      absenceType,
      absences: studentClassBookService.getAbsencesDplr({
        schoolYear,
        classBookId,
        personId,
        type: absenceType
...
type Absence = ArrayElementType<StudentClassBook_GetAbsencesForCurriculumAndType>;
...
export class AbsencesDplrComponent implements OnInit {
  @Input() data!: {
    ...
    absences: StudentClassBook_GetAbsencesDplr;
  };
