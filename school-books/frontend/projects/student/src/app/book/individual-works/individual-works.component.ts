...
import {
  ...
  StudentClassBook_GetIndividualWorks
...
export class IndividualWorksComponent {
  ...
  dataSource: TableDataSource<StudentClassBook_GetIndividualWorks>;
  ...
  constructor(private studentClassBookService: StudentClassBookService, route: ActivatedRoute) {
    ...
    this.dataSource = new TableDataSource((sortBy, sortDirection, offset, limit) =>
      studentClassBookService.getIndividualWorks({ schoolYear, classBookId, personId, offset, limit })
    );
  }
}
