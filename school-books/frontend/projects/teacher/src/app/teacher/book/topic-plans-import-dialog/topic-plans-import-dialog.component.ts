...
export type TopicPlansImportDialogData = {
  schoolYear: number;
  instId: number;
  classBookId: number;
  curriculumId: number;
...
@Component({
  selector: 'sb-topic-plans-import-dialog',
  templateUrl: './topic-plans-import-dialog.component.html'
})
export class TopicPlansImportDialogComponent implements TypedDialog<TopicPlansImportDialogData, void>, OnDestroy {
  d!: TopicPlansImportDialogData;
  r!: void;
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: TopicPlansImportDialogData,
    private classBookTopicPlanItemsService: ClassBookTopicPlanItemsService,
    private actionService: ActionService,
    private dialogRef: MatDialogRef<TopicPlansImportDialogComponent>,
