...
export type ExamResultProtocolViewDialogData = {
  schoolYear: number;
  instId: number;
...
export class ExamResultProtocolViewDialogSkeletonComponent extends SkeletonComponentBase {
  d!: ExamResultProtocolViewDialogData;
  r!: void;
  constructor(
    @Inject(MAT_DIALOG_DATA)
    data: ExamResultProtocolViewDialogData
  ) {
    super();
    ...
    this.resolve(ExamResultProtocolViewDialogComponent, {
      schoolYear,
      instId,
...
@Component({
  selector: 'sb-exam-result-protocol-student-view-dialog',
  templateUrl: './exam-result-protocol-student-view-dialog.component.html'
})
export class ExamResultProtocolViewDialogComponent implements OnDestroy {
  @Input() data!: {
    schoolYear: number;
    instId: number;
    examResultProtocolId: number;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ExamResultProtocolViewDialogComponent>,
        ...
        httpAction: () => {
          return this.examResultProtocolsService
            .createStudent({
              ...
              createExamResultProtocolStudentCommand: { students }
            })
            .toPromise()
            .then(() => {
