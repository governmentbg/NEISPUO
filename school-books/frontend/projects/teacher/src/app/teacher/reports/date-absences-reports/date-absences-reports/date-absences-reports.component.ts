...
import {
  ...
  DateAbsencesReports_GetAll
} from 'projects/sb-api-client/src/api/dateAbsencesReports.service';
import { TableDataSource } from 'projects/shared/components/table/table-datasource';
import { throwParamError, tryParseInt } from 'projects/shared/utils/various';

@Component({
  selector: 'sb-date-absences-reports',
  templateUrl: './date-absences-reports.component.html'
})
export class DateAbsencesReportsComponent {
  dataSource: TableDataSource<DateAbsencesReports_GetAll>;
  ...
  constructor(dateAbsencesReportsService: DateAbsencesReportsService, route: ActivatedRoute) {
    ...
    this.dataSource = new TableDataSource((sortBy, sortDirection, offset, limit) =>
      dateAbsencesReportsService.getAll({ schoolYear, instId, offset, limit })
    );
  }
}
