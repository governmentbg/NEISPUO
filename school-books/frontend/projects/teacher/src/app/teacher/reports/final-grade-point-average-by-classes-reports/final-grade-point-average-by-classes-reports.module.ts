...
import {
  FinalGradePointAverageByClassesReportViewComponent,
  FinalGradePointAverageByClassesReportViewSkeletonComponent
} from './final-grade-point-average-by-classes-report-view/final-grade-point-average-by-classes-report-view.component';
import { FinalGradePointAverageByClassesReportsRoutingModule } from './final-grade-point-average-by-classes-reports-routing.module';
...
@NgModule({
  declarations: [
    FinalGradePointAverageByClassesReportsComponent,
    FinalGradePointAverageByClassesReportViewComponent,
    FinalGradePointAverageByClassesReportViewSkeletonComponent
  ],
  imports: [
    FinalGradePointAverageByClassesReportsRoutingModule,
    CommonFormUiModule,
    ActionServiceModule,
    DatePipesModule,
    DateFieldModule,
...
export class FinalGradePointAverageByClassesReportsModule {}
