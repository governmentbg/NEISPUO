...
import {
  ...
  ScheduleAndAbsencesByMonthReports_GetAll
} from 'projects/sb-api-client/src/api/scheduleAndAbsencesByMonthReports.service';
import { TableDataSource } from 'projects/shared/components/table/table-datasource';
import { throwParamError, tryParseInt } from 'projects/shared/utils/various';

@Component({
  selector: 'sb-schedule-and-absences-by-month-reports',
  templateUrl: './schedule-and-absences-by-month-reports.component.html'
})
export class ScheduleAndAbsencesByMonthReportsComponent {
  dataSource: TableDataSource<ScheduleAndAbsencesByMonthReports_GetAll>;
  ...
  constructor(
    ...
    this.dataSource = new TableDataSource((sortBy, sortDirection, offset, limit) =>
      scheduleAndAbsencesByMonthReportsService.getAll({ schoolYear, instId, offset, limit })
    );
  }
}
