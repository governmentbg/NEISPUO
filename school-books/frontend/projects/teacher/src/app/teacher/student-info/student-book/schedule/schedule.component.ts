...
import {
  ...
  StudentInfoClassBook_GetSchedule
...
export class ScheduleSkeletonComponent extends SkeletonComponentBase {
  constructor(
    ...
    this.resolve(ScheduleComponent, {
      ...
      year,
      weekNumber,
      schedule: studentInfoClassBookService.getSchedule({
        schoolYear,
        instId,
        classBookId,
        personId,
...
export class ScheduleComponent implements OnInit, OnDestroy {
  @Input() data!: {
    ...
    year: number;
    weekNumber: number;
    schedule: StudentInfoClassBook_GetSchedule;
    ...
    this.showIndividualCurriculumControl.valueChanges
      .pipe(
        ...
        switchMap((showIndividualCurriculum) =>
          this.studentInfoClassBookService
            .getSchedule({
...
function getTemplateData(data: ScheduleComponent['data'], studentSchedule: StudentInfoClassBook_GetSchedule | null) {
