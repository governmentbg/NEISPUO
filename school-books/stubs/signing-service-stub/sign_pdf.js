// copied from https://github.com/RichardBray/pdf_sign
...
const { PDFArrayCustom } = require("./pdf_array_custom");

class SignPDF {
  constructor(pdf, cert, passphrase) {
    this.pdfDoc = pdf;
  ...
  async _addPlaceholder() {
    ...
    const [x, y, width, height] = [30, 30, 100, 50];
    ...
    const widgetDict = loadedPdf.context.obj({
      ...
      Subtype: 'Widget',
      FT: 'Sig',
      Rect: [x, y, width, height], // Signature rect size
      V: signatureDictRef,
