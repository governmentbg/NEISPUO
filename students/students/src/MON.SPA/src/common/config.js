...
export const config = {
    ...
    reportDesignerBaseUrl: parse(process.env.VUE_APP_API + "ReportDesigner", 'http://localhost:44398/ReportDesigner'),
    ...
    helpdesk: parse(process.env.VUE_APP_HELPDESK, 'https://helpdesk-neispuo.mon.bg'),
    ...
    mode: parse(process.env.VUE_APP_MODE, ''),
};
