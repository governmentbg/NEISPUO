namespace MON.Services.Implementations.DiplomaCode
{
    ...
    public class Diploma_3_44_3_Code : CodeService
    {
        private const int FirstEducationalLevelBasicDocumentId = 14;

        public Diploma_3_44_3_Code(DbServiceDependencies<CodeService> dependencies, IServiceProvider serviceProvider)
