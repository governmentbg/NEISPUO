...
{
    public class SchoolClassValidator : StudentClassBaseValidator
    {
        public SchoolClassValidator(MONContext context, IUserInfo userInfo, IInstitutionService institutionService)
