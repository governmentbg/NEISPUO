namespace MON.Report.Service.Diploma
{
    ...
    public class Diploma_3_44_1ReportService : DiplomaReportBaseService<Diploma_3_44_1ReportService>
    {
        ...
        public override object LoadReport(IDictionary<string, object> parameters)
        {
            ...
            diploma.SpecialityForeign = _db.Sppoospecialities.FirstOrDefault(i => i.SppoospecialityCode == diploma.SpecialityCode)?.NameEn ?? null;
            diploma.ProfessionForeign = _db.Sppooprofessions.FirstOrDefault(i => i.SppooprofessionCode == diploma.ProfessionCode)?.NameEn ?? null;
