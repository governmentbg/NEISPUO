namespace MON.Report.Service.Diploma
{
    ...
    public class Diploma_3_44_3ReportService : DiplomaReportBaseService<Diploma_3_44_3ReportService>
    {
        ...
        public override object LoadReport(IDictionary<string, object> parameters)
        {
            ...
            diploma.SpecialityForeign = _db.Sppoospecialities.FirstOrDefault(i => i.SppoospecialityCode == diploma.SpecialityCode)?.NameFr ?? null;
            diploma.ProfessionForeign = _db.Sppooprofessions.FirstOrDefault(i => i.SppooprofessionCode == diploma.ProfessionCode)?.NameFr ?? null;
