...
{
    public class Diploma_R_1ReportService : DiplomaReportBaseService<Diploma_R_1ReportService>
    {
        public Diploma_R_1ReportService(DbReportServiceDependencies<Diploma_R_1ReportService> dependencies)
            : base(dependencies)
        {
        }
        ...
        public override object LoadReport(IDictionary<string, object> parameters)
        {
            ...
            Diploma_R_1Model diploma = JsonConvert.DeserializeObject<Diploma_R_1Model>(json);
            ...
            diploma.ExternalDocDate = FunctionsExtension.TryGetValue(diploma.DynamicData, "externalDocDate");
            //документът може да няма дата, а само година или месец и година
