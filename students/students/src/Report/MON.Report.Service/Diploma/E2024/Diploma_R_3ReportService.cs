...
{
    public class Diploma_R_3ReportService : DiplomaReportBaseService<Diploma_R_3ReportService>
    {
        public Diploma_R_3ReportService(DbReportServiceDependencies<Diploma_R_3ReportService> dependencies)
            : base(dependencies)
        {
        }
