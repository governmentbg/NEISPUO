...
{
    public class Diploma_3_10ReportService : DiplomaReportBaseService<Diploma_3_10ReportService>
    {
        public Diploma_3_10ReportService(DbReportServiceDependencies<Diploma_3_10ReportService> dependencies)
            : base(dependencies)
        {
        }
        ...
        public override object LoadReport(IDictionary<string, object> parameters)
        {
            ...
            diploma.ExternalDocYear = FunctionsExtension.TryGetValue(diploma.DynamicData, "externalDocYear");
