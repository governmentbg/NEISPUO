...
{
    public class Diploma_3_13ReportService : DiplomaReportBaseService<Diploma_3_13ReportService>
    {
        public Diploma_3_13ReportService(DbReportServiceDependencies<Diploma_3_13ReportService> dependencies)
            : base(dependencies)
        {
        }
        ...
        public override object LoadReport(IDictionary<string, object> parameters)
        {
            ...
            Diploma_R_3Model diploma = JsonConvert.DeserializeObject<Diploma_R_3Model>(json);
