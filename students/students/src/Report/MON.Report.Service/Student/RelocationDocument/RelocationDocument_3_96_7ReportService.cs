namespace MON.Report.Service.Student.RelocationDocument
{
    ...
    public class RelocationDocument_3_96_7ReportService : ReportService<RelocationDocument_3_96_7ReportService>
    {
        ...
        public RelocationDocument_3_96_7ReportService(
            DbReportServiceDependencies<RelocationDocument_3_96_7ReportService> dependencies,
        ...
        public override object LoadReport(IDictionary<string, object> parameters)
        {
            ...
            List<int> includedBasicClasses = new List<int> { 5, 6, 7 };
                        ...
                        foreach (LodAssessmentCreateModel subject in part.SubjectAssessments)
                        {
                            ...
                            {  
                                case 7:
                                    ...
                                    break;
                                case 6:
                                    printModel.SixthGradeEvaluationGrade = annualGrades
