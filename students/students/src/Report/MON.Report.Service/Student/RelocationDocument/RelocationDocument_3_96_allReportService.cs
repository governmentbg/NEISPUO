namespace MON.Report.Service.Student.RelocationDocument
{
    ...
    internal class RelocationDocument_3_96_allReportService : ReportService<RelocationDocument_3_96_allReportService>
    {
        ...
        public RelocationDocument_3_96_allReportService(
            DbReportServiceDependencies<RelocationDocument_3_96_allReportService> dependencies,
        ...
        public override object LoadReport(IDictionary<string, object> parameters)
        {
            ...
            List<StudentLodAssessmentListModel> assessmentsList = _db.VStudentLodAsssessmentLists
                .Where(x => x.PersonId == model.PersonId && x.BasicClassId.HasValue && x.BasicClassId.Value == model.BasicClassId)
