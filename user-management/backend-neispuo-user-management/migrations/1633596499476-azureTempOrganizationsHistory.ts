...
export class azureTempOrganizationsHistory1633596499476 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE azure_temp.Organizations_History (
                RowID int NOT NULL,
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('DROP TABLE azure_temp.Organizations_History;', undefined);
    }
}
