...
export class CreateStudentUsersView1633693861280 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE VIEW azure_temp.StudentUsers
            AS
                SELECT
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('DROP VIEW azure_temp.StudentUsers;', undefined);
    }
}
