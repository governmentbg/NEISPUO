...
export class AzureDataNotFoundException extends HttpException {
    ...
    constructor() {
        super(CONSTANTS.RESPONSE_PARAM_ERROR_MESSAGE_AZURE_DATA_NOT_FOUND, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
