...
export class CurriculumNotFoundException extends HttpException {
    ...
    constructor() {
        super(CONSTANTS.RESPONSE_PARAM_ERROR_MESSAGE_CURRICULUM_NOT_FOUND, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
