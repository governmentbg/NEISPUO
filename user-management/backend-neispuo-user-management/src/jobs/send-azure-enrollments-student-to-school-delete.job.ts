...
@Injectable()
export class SendAzureEnrollmentsStudentToSchoolDeleteJob {
    constructor(private azureEnrollmentsService: AzureEnrollmentsService) {}

    private previousJobHasFinished = true;

    @Cron(CONSTANTS.JOB_CRON_SEND_AZURE_ENROLLMENTS_STUDENT_TO_SCHOOL_DELETE, {
        name: CONSTANTS.JOB_NAME_SEND_AZURE_ENROLLMENTS_STUDENT_TO_SCHOOL_DELETE,
    })
