...
@Injectable()
export class SendAzureEnrollmentsTeacherToSchoolDeleteJob {
    constructor(private azureEnrollmentsService: AzureEnrollmentsService) {}

    private previousJobHasFinished = true;

    @Cron(CONSTANTS.JOB_CRON_SEND_AZURE_ENROLLMENTS_TEACHER_TO_SCHOOL_DELETE, {
        name: CONSTANTS.JOB_NAME_SEND_AZURE_ENROLLMENTS_TEACHER_TO_SCHOOL_DELETE,
    })
