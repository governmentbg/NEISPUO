...
import { AzureClassesCrudService } from './azure-classes-crud.service';
...
@Controller('v1/azure-classes')
export class AzureClassesCrudController implements CrudController<AzureClassesEntity> {
    constructor(public service: AzureClassesCrudService) {}
}
