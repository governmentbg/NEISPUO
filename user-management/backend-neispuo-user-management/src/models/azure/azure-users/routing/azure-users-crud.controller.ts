...
import { AzureUsersCrudService } from './azure-users-crud.service';
...
@Controller('v1/azure-users')
export class AzureUsersCrudController implements CrudController<AzureUsersEntity> {
    constructor(public service: AzureUsersCrudService) {}
}
