...
const packageFiles = [
  './package.json',
  './package-lock.json',
  './backend-neispuo-user-management/package.json',
  './backend-neispuo-user-management/package-lock.json',
  './frontend-neispuo-user-management/package.json',
  './frontend-neispuo-user-management/package-lock.json',
];
...
execSync(
  `git remote set-url origin https://georgi.kotov:${process.env.AZURE_PAT_DECODED}@dev.azure.com/dssbg/NEISPUO%20Maintenance/_git/mon-neispuo-user-management`,
);
